...
const EducationalText = () => {
  return (
    <>
      ...
      <ol>
        <li>
          Look in <code className="text-sm font-bold text-gray-900">frontend/components/ContractView.tsx</code> -
          you&apos;ll see <code className="text-sm font-bold text-gray-900">getGreeting</code> and{' '}
          <code className="text-sm font-bold text-gray-900">setGreeting</code> being called on{' '}
        ...
        <li>
          ...
          <code className="text-sm font-bold text-gray-900">./contract</code> – this is the source code for your{' '}
